...
ct_is_nodeport4(const void *map, struct ipv4_ct_tuple *ingress_tuple)
{
...
static __always_inline bool
ct_is_nodeport6(const void *map, struct ipv6_ct_tuple *ingress_tuple)
{
	int prev_flags = ingress_tuple->flags;
	struct ct_entry *entry;
...
static __always_inline bool
ct_is_nodeport4(const void *map __maybe_unused,
		struct ipv4_ct_tuple *ingress_tuple __maybe_unused)
{
	return 0;
}

static __always_inline bool
ct_is_nodeport6(const void *map __maybe_unused,
		struct ipv6_ct_tuple *ingress_tuple __maybe_unused)
{
	return 0;
}

static __always_inline void
ct_update_nodeport(const void *map __maybe_unused,
		   const void *tuple __maybe_unused,
		   const bool node_port __maybe_unused)
{
}
#endif /* CONNTRACK */
